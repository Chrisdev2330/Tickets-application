class UsersController < ApplicationController
  ...
  before_action :rol_user, only: %i[ show edit update  ]
  ...
  def update_profile
    respond_to do |format|
      if @user.update(password: params[:password], password_confirmation: params[:password_confirmation])
        format.html { redirect_to root_path, notice: "El usuario ha sido actualizado" }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:username, :email, :password, :password_confirmation, :rol)
    end
